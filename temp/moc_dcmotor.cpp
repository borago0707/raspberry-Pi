...
struct qt_meta_stringdata_DCmotor_t {
    QByteArrayData data[1];
    char stringdata0[8];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_DCmotor_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_DCmotor_t qt_meta_stringdata_DCmotor = {
    {
QT_MOC_LITERAL(0, 0, 7) // "DCmotor"
...
QT_INIT_METAOBJECT const QMetaObject DCmotor::staticMetaObject = { {
    QMetaObject::SuperData::link<QObject::staticMetaObject>(),
    qt_meta_stringdata_DCmotor.data,
    qt_meta_data_DCmotor,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void *DCmotor::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_DCmotor.stringdata0))
